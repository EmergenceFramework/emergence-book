...
1. Initialize a Chef Habitat plan for the PHP application:
...
2. Initialize default configuration for the PHP application:
...
3. Initialize a Chef Habitat plan for running PHP application + nginx + database:
